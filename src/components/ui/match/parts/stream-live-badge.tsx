...
export function StreamLiveBadge({ label, className }: StreamLiveBadgeProps) {
  return (
    <div className={`relative flex items-center gap-1.5 overflow-visible ${className ?? ""}`}>
      ...
      <div className="rounded-6 relative flex h-[30px] items-center gap-1.5 bg-red-600 px-2.5 shadow-[0_0_12px_rgba(220,38,38,0.6)]">
        <span className="relative flex size-2.5 shrink-0">
          ...
          />
          <span className="relative inline-flex size-2.5 rounded-full bg-white shadow-[0_0_4px_rgba(255,255,255,0.8)]" />
        </span>
